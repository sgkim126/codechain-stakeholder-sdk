...
exports.module = {
    ...
    builder: function (args) {
        return args
            .option("from", {
            coerce: util_1.coerce("from", lib_1.PlatformAddress.ensure),
            demand: true
        })
            .option("to", {
            coerce: util_1.coerce("to", lib_1.PlatformAddress.ensure),
            demand: true
        })
            .option("quantity", {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, printSummary(sdk, blockNumber, argv.from, argv.to, {
                            ccsChanges: argv.quantity,
                            cccChanges: lib_1.U64.ensure(argv.fee)
                        })];
                case 2:
                    _f.sent();
                    return [4 /*yield*/, util_1.askPasspharaseFor(argv.from)];
                case 3:
                    passphrase = _f.sent();
                    tx = src_1.createTransferCCSTransaction(sdk, argv.to, argv.quantity);
                    ...
                    return [4 /*yield*/, sdk.rpc.chain.getSeq(argv.from)];
                ...
                case 6:
                    ...
                    return [4 /*yield*/, printSummary(sdk, newBlockNumber, argv.from, argv.to)];
                case 7:
                    _f.sent();
                    return [2 /*return*/];
            }
...
function printSummary(sdk, blockNumber, sender, receiver, changes) {
    return __awaiter(this, void 0, void 0, function () {
        var _a, _b, ccsChanges, _c, cccChanges, cccBalance, undelegated, delegations, balance, undelegated, delegations, balance;
        return __generator(this, function (_d) {
            switch (_d.label) {
                case 0:
                    ...
                    return [4 /*yield*/, sdk.rpc.chain.getBalance(sender, blockNumber)];
                case 1:
                    cccBalance = _d.sent();
                    return [4 /*yield*/, src_1.getUndelegatedCCS(sdk, sender, blockNumber)];
                case 2:
                    undelegated = _d.sent();
                    return [4 /*yield*/, src_1.getDelegations(sdk, sender, blockNumber)];
                case 3:
                    delegations = _d.sent();
                    balance = undelegated.plus(summerizer_1.sumU64(delegations.map(function (x) { return x.quantity; })));
                    console.log.apply(console, __spread(["CCC Balance:"], util_1.minusChangeArgs(cccBalance, cccChanges)));
                    console.log.apply(console, __spread(["CCS Balance:"], util_1.minusChangeArgs(balance, ccsChanges)));
                    console.log.apply(console, __spread(["Undelegated CCS:"], util_1.minusChangeArgs(undelegated, ccsChanges)));
                    console.groupEnd();
                    console.group("Receiver", receiver.value);
                    return [4 /*yield*/, src_1.getUndelegatedCCS(sdk, receiver, blockNumber)];
                case 4:
                    undelegated = _d.sent();
                    return [4 /*yield*/, src_1.getDelegations(sdk, receiver, blockNumber)];
                case 5:
                    delegations = _d.sent();
                    balance = undelegated.plus(summerizer_1.sumU64(delegations.map(function (x) { return x.quantity; })));
                    console.log.apply(console, __spread(["CCS Balance:"], util_1.plusChangeArgs(balance, ccsChanges)));
