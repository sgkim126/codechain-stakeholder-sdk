    ...
    handler: util_1.asyncHandler(function (argv) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 3:
                    passphrase = _f.sent();
                    tx = src_1.createDelegateCCSTransaction(sdk, argv.to, argv.quantity);
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 2:
                    ...
                    console.log.apply(console, __spread(["Delegations (out):"], util_1.plusChangeArgs(delegationsTo.sum, ccsChanges)));
                    console.groupEnd();
                    console.group("Delegatee", delegatee.value);
                    {
                        ...
                        console.log.apply(console, __spread(["Delegations (in):"], util_1.plusChangeArgs(delegationsFrom.sum, ccsChanges)));
                    }
                    console.groupEnd();
                    console.log.apply(console, __spread(["Delegations between:"], util_1.plusChangeArgs(summary.delegations(delegator, delegatee), ccsChanges)));
                    return [2 /*return*/];
            }
        });
    });
